...
WebAppConfig -ApiKey "API-SFVPQ7CI5DELMEXG0Y3XZKLE8II" -OctopusServerUrl "https://pip-octo-wspdpr.westus.cloudapp.azure.com" -Environments @("Dev") -Roles @("Web-VMSS") -ServerPort 10943
